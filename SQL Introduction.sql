...
-- find all products from the products table whose stock level is in the range -- of 500
-- to 1200. Order by Price from least to greatest. Hint: Use the between keyword
select * from bestbuy.products
